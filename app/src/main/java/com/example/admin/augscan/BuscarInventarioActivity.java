...
// INICIO BANCO DE DADOS LOCAL
        ...
        dbHelper = new DBHelper(BuscarInventarioActivity.this);
...
// INICIO FUNÇAO OBJETOS
        ...
        scantosearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), EscanearQrcodeBuscarInventarioActivity.class));
            }
        });
...
// FIM FUNÇAO OBJETOS
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Items, UsersViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Items, UsersViewHolder>
                (Items.class,
                        R.layout.inventario_list_layout,
                        UsersViewHolder.class,
                        mdatabaseReference) {
            @Override
            protected void populateViewHolder(UsersViewHolder viewHolder, Items model, int position) {
                viewHolder.setDetails(getApplicationContext(), model.getitemmaterial(), model.getiteminfo(), model.getitemmilitar(), model.getitemdata(), model.getitemquantia());
            }
        };
...
// INICIO APARECER LISTA AO BUSCAR
    ...
    public static class UsersViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDetails(Context ctx, String itemmaterial, String iteminfo, String itemmilitar, String itemdata, String itemquantia) {
...
// FIM EXCLUIR MATERIAL
        ...
        public void editarMaterial() {
            ...
            TextView textviewitemmaterial = (TextView) mView.findViewById(R.id.viewitemmaterial);
            TextView botaoeditar = (TextView) mView.findViewById(R.id.buttonEditar);
            ...
            String textitemmaterial = textviewitemmaterial.getText().toString();

            dReference = FirebaseDatabase.getInstance().getReference("Users").child(resultemail).child("Inventario").child(textitemmaterial);
            ...
            botaoeditar.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    msgBox.setIcon(R.drawable.ic_lapis_preto_24dp);
                    msgBox.setMessage("Editar o material " + '"' + textitemmaterial + '"' + "?");
                    msgBox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogInterface, int which) {
                            ...
                            dReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    String itemano = dataSnapshot.child("itemano").getValue().toString();
                                    String itemdata = dataSnapshot.child("itemdata").getValue().toString();
                                    ...
                                    String itemmes = dataSnapshot.child("itemmes").getValue().toString();
                                    ...
                                    String itemtipo = dataSnapshot.child("itemtipo").getValue().toString();

                                    Intent intent = new Intent(mContext, EditarInventarioActivity.class);
                                    intent.putExtra("material2_key", textitemmaterial);
                                    intent.putExtra("material_key", itemmaterial);
                                    intent.putExtra("quantia_key", itemquantia);
                                    intent.putExtra("militar_key", itemmilitar);
                                    intent.putExtra("data_key", itemdata);
                                    intent.putExtra("info_key", iteminfo);
                                    intent.putExtra("ano_key", itemano);
                                    intent.putExtra("mes_key", itemmes);
                                    intent.putExtra("destino_key", itemdestino);
                                    intent.putExtra("tipo_key", itemtipo);
        ...
        public void cautelarMaterial() {

            TextView textviewitemmaterial = (TextView) mView.findViewById(R.id.viewitemmaterial);
            TextView botaocautelar = (TextView) mView.findViewById(R.id.buttonCautelar);
            ...
            botaocautelar.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {

                    AlertDialog.Builder msgBox = new AlertDialog.Builder(mView.getContext());
                    msgBox.setTitle("Cautelar");
                    msgBox.setIcon(R.drawable.ic_seta_cima_preto_24dp);
                    msgBox.setMessage("Cautelar o material " + '"' + textitemmaterial + '"' + "?");
                    msgBox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogInterface, int which) {
                            ...
                            dReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    Intent intent = new Intent(mContext, CautelarDoInventarioActivity.class);
                                    intent.putExtra("material2_key", textitemmaterial);
                                    intent.putExtra("material_key", itemmaterial);
                                    intent.putExtra("quantia_key", itemquantia);
                                    intent.putExtra("militar_key", itemmilitar);
