...
public class CautelarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DBHelper(CautelarActivity.this);
        ...
        scanbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), EscanearQrcodeCautelarMaterialActivity.class));
            }
        });
        ...
        scanbutton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), EscanearQrcodeCautelarMilitarActivity.class));
            }
        });
    ...
    private void salvarnaPlanilha() {
        ...
        if (!TextUtils.isEmpty(itemmaterial) && !TextUtils.isEmpty(itemmilitar) && !TextUtils.isEmpty(iteminfo) && !TextUtils.isEmpty(itemquantia)) {
            ...
            Toast.makeText(CautelarActivity.this, "Preencha todos os campos", Toast.LENGTH_SHORT).show();
        }
        ...
        if (id > 0) {
            ...
            Toast.makeText(CautelarActivity.this, "Algo deu errado\nErro (x0001)", Toast.LENGTH_SHORT).show();
        }
...
//                      itemdestinoSpinner.setSelection(0);
                        Toast.makeText(CautelarActivity.this, itemmaterial + "\nCautelado com sucesso", Toast.LENGTH_SHORT).show();
                    } else {
                        if (itemquantiainventario > itemquantiacautela) {
